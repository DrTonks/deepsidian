...
export const defaults: Settings = { packageRoot: '', nodePath: '', dshHome: '', provider: '', model: '', background: '', checkUpdates: true, reasoningEffort: '', maxTokens: 4096, webSearch: true, webFetch: true, setupComplete: false, autoConnect: true, useMemory: true, idleMemory:false, manageMemory:false };
