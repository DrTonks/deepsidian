...
const allow = ['src','scripts','tests','fixtures','docs','.github','.gitignore','.editorconfig','package.json','package-lock.json','tsconfig.json','manifest.json','styles.css','README.md','AGENTS.md','LICENSE','THIRD-PARTY-NOTICES.txt'];
