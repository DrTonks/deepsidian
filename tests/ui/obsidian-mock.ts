...
export class Setting {
  ...
  setHeading(){this.name.closest('.setting-item')?.classList.add('setting-item-heading');return this;}
...
export class PluginSettingTab {containerEl=document.createElement('div');constructor(_app:any,_plugin:any){}}
