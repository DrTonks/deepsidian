...
export function setIcon(element:HTMLElement,name:string) {
  element.innerHTML = `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="6" aria-hidden="true">${icons.get(name) ?? ({plus:'<path d="M50 20v60M20 50h60"/>',x:'<path d="M25 25l50 50M25 75l50-50"/>','arrow-up':'<path d="M50 80V20L25 45M50 20l25 25"/>','file-text':'<path d="M25 15h35l15 15v55H25zM38 48h24M38 63h24"/>','settings-2':'<path d="M20 30h60M20 70h60M40 20v20M65 60v20"/>',square:'<rect x="25" y="25" width="50" height="50"/>','paperclip':'<path d="M40 70V35a10 10 0 0120 0v40a20 20 0 01-40 0V30a30 30 0 0160 0v40"/>'} as Record<string,string>)[name] ?? '<circle cx="50" cy="50" r="24"/>'}</svg>`;
}
